...
# Menu bar: hide remaining battery time; hide percentage
...
# Increase window resize speed for Cocoa applications (default: 0.2)
...
# Enable subpixel font rendering on non-Apple LCDs (default: 0)
